...
public class MusicLexer extends Lexer {
    ...
    public final void mTONE() throws RecognitionException {
        try {
            int _type = TONE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/parser/Music.g:261:21: ( 'Tone' )
            // src/parser/Music.g:261:23: 'Tone'
            {
            match("Tone"); 
    ...
    public final void mDOUBLE_BAR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/parser/Music.g:263:22: ( '||' )
            // src/parser/Music.g:263:24: '||'
            {
            match("||"); 
    ...
    public final void mNOTE() throws RecognitionException {
        try {
            int _type = NOTE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/parser/Music.g:274:21: ( ( 'Do' | 'Re' | 'Mi' | 'Fa' | 'Sol' | 'La' | 'Si' | 'Silence' ) )
            // src/parser/Music.g:274:23: ( 'Do' | 'Re' | 'Mi' | 'Fa' | 'Sol' | 'La' | 'Si' | 'Silence' )
            {
            // src/parser/Music.g:274:23: ( 'Do' | 'Re' | 'Mi' | 'Fa' | 'Sol' | 'La' | 'Si' | 'Silence' )
            int alt1=8;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                ...
                case 7 :
                    ...
                    break;
                case 8 :
                    // src/parser/Music.g:274:60: 'Silence'
                    {
                    match("Silence"); 
